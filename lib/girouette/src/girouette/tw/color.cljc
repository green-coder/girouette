...
(def tw-v3-unified-colors-extended
  "The colors defined in Tailwind as 'v3 Unified', plus some extra colors for backward compatibility."
  (-> tw-v3-unified-colors
      (into (set/rename-keys tw-v3-unified-colors {"lightBlue" "sky"
                                                   "warmGray" "stone"
                                                   "trueGray" "neutral"
                                                   "coolGray" "gray"
                                                   "blueGray" "slate"}))))
